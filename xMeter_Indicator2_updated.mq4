...
#define TABSIZE  15                    // scale of currency's power !!!DON'T CHANGE THIS NUMBER!!!
...
/* You can change any of the following arrays */
   ...
   string aPair[]   = {"EURUSD","GBPUSD","AUDUSD","NZDUSD","USDJPY","USDCHF","USDCAD","EURCAD","CADJPY","XAUUSD", "XAGUSD",
                       "EURJPY","EURGBP","EURCHF","EURAUD","EURNZD","GBPJPY","GBPCHF"};
                       
/* The following can also be changed but both must have the same dimension */
   string aMajor[] = {"USD","EUR","GBP","CHF","CAD","AUD","NZD","JPY","XAU", "XAG"};
...
void initGraph()
  {
   ...
   objectCreate("line",15,6,"-------------------------------------------------------------------------",10,"Arial",DimGray);  
   objectCreate("line1",15,27,"-------------------------------------------------------------------------",10,"Arial",DimGray);  
   objectCreate("line2",15,69,"-------------------------------------------------------------------------",10,"Arial",DimGray);
   objectCreate("sign",15,1,"»»» Price Powered Meter System™ ©GPL «««",8,"Arial Narrow",DimGray);
   WindowRedraw();
  }
//+------------------------------------------------------------------+
